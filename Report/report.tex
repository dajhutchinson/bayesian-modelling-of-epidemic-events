...
\subsubsection{Stochastic SIR Model}
  ...
  \begin{box_definition}{It\^o Process}
    A stochastic process $\{X_t\}_{t\in[0,T]}$ is called an It\^o Process if it has the following form
    \[ X_t=X_0+\int_0^tb(u,X_u)d_u+\int_0^t\sigma(u,X_u)dW_u \]
