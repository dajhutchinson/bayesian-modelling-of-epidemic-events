...
\subsubsection*{In Practice}
  ...
  \par However, although sufficient statistics do exist for all models, as the identity function is a sufficient statistic for all models, they are not necessarily the best choice of summary statistic when implementing computational methods as they may provide very little dimensionality reduction relative to some other statistics which still maintain a large about of the relevant data from a sample. Moreover, the Pitman-Koopman-Darmoois theorem \textbf{Theorem \ref{the_pitman_koopman_darmois}} shows that  summary statistics which provide a high level of dimensionality reduction only exist for probability distributions from exponential families.
