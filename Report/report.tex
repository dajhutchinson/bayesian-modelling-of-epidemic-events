...
\subsubsection*{Theory}
  ...
  \begin{box_theorem}[Fisher-Neyman Factorisation Criterion]
  ...
  \begin{box_theorem}[Condition for Minimal Sufficiency]
  ...
  % TODO checking for minimal sufficiency (http://www.stat.cmu.edu/~siva/705/lec12.pdf)

  % TODO likelihood and sufficiency (http://www.stat.cmu.edu/~siva/705/lec11.pdf)

\subsubsection*{In Practice}
  % TODO - Sufficiency and ABC (If summary stats are not sufficient then the posterior will only ever be an approxiamtion)
  ...
  % TODO sufficient statistics are rare (Pitman–Koopman–Darmois theorem)
